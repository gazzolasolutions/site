// ISO 3166-1 alpha-2 code → international dialing code.
...
const RAW: [string, string][] = [
  ...
  ["BG", "359"], ["BH", "973"], ["BI", "257"], ["BJ", "229"], ["BM", "1"],
  ["BN", "673"], ["BO", "591"], ["BQ", "599"], ["BR", "55"], ["BS", "1"],
  ["BT", "975"], ["BW", "267"], ["BY", "375"], ["BZ", "501"], ["CA", "1"],
  ["CD", "243"], ["CF", "236"], ["CG", "242"], ["CH", "41"], ["CI", "225"],
  ["CK", "682"], ["CL", "56"], ["CM", "237"], ["CN", "86"], ["CO", "57"],
  ["CR", "506"], ["CU", "53"], ["CV", "238"], ["CW", "599"], ["CY", "357"],
  ...
  ["IM", "44"], ["IN", "91"], ["IQ", "964"], ["IR", "98"], ["IS", "354"],
...
export const COUNTRY_CODES: CountryCode[] = RAW
  .map(([iso, dial]) => ({ label: iso, code: `+${dial}`, flag: isoToFlag(iso) }))
  .sort((a, b) => a.label.localeCompare(b.label));

export const DEFAULT_COUNTRY: CountryCode = COUNTRY_CODES.find((c) => c.label === "US")!;
